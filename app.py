...
class Symptom_Checker:
    ...
    def precaution(self,data,val):
        ...
        if len(s)<=0:
            ...
            prec=pd.read_csv(r'C:\Users\hp\Desktop\Downloads\symptom_checker-main\symptom_checker-main\symptom_precaution.csv')
    ...
    def diagnose(self,val):        
        data=pd.read_csv(r'C:\Users\hp\Desktop\Downloads\symptom_checker-main\symptom_checker-main\dataset.csv')        
